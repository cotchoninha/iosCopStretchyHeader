...
class StretchyHeaderCustomLayout: UICollectionViewFlowLayout {
	...
	override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
		...
		//considering that you want your image to expand when you drag it down you need to set it's height to the result of your desired default height + your content offset Y - run your code to see the behaviour *** not working? check the tip in the bottom of the page//2//
...
//4//dragging your collection view up will make your offsetY positive and you don't want that. So, make sure you return it before it gets positive.👍🏼
